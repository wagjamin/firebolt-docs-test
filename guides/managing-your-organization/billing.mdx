...
1. On the [Firebolt Workspace page](https://go.firebolt.io/), select the **Configure**(<img src="/assets/images/configure-icon.png" alt="AggIndex" width="14" style={{"display": "inline"}}/>) icon from the left navigation pane.
