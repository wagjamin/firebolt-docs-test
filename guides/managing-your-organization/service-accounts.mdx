...
1. Select the **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The icon to open the Configure Space." width="20" style={{"display": "inline"}}/>) in the left navigation pane to open the **Configure Space**.
...
4. Use the syntax in the following example code to create a service account in the **SQL Script Editor**:
...
1. Select the Govern icon (<img src="/assets/images/govern-icon.png" alt="The icon to open the Govern Space." width="20" style={{"display": "inline"}}/>) in the left navigation pane to open the **Govern Space**.
...
1. Select **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The icon to open the Configure Space." width="20" style={{"display": "inline"}}/>) in the left navigation pane to open the **Configure Space**.
2. Select **Service accounts** from the left sub-menu bar.
