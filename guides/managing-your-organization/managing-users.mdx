...
## <img src="/assets/images/icon-login.png" alt="Icon for a Firebolt login for human access." width="30" style={{"display": "inline"}}/> Logins
...
## <img src="/assets/images/icon-service-account.png" alt="Icon for a Firebolt service account for programmatic access." width="30" style={{"display": "inline"}}/> Service accounts
...
## <img src="/assets/images/icon-user-bangs.png" alt="Icon for a Firebolt user." width="30" style={{"display": "inline"}}/> Users
...
1. Select the Configure icon (<img src="/assets/images/configure-icon.png" alt="The Firebolt Configure Space icon." width="12" style={{"display": "inline"}}/>) in the left navigation pane to open the **Configure Space**.
2. Select **Logins**.
...
1. Select the **Govern** icon (<img src="/assets/images/govern-icon.png" alt="The Firebolt Govern Space icon." width="12" style={{"display": "inline"}}/>) in the left navigation pane to open the **Govern Space**.
...
Use the syntax in the following example code and the [ALTER_USER](/reference-sql/commands/access-control/alter-user) statement to link a user to a login in the **SQL Script Editor** in the **Develop Space**:
