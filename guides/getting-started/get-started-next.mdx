...
1. On the [Firebolt Workspace page](https://go.firebolt.io/), select the **Configure**(<img src="/assets/images/configure-icon.png" alt="AggIndex" style={{"display": "inline"}} width="14"/>) icon from the left navigation pane.
