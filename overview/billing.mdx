...
2. In the Firebolt Workspace, select the Configure(<img src="/assets/images/configure-icon.png" width="20" alt="The Firebolt Configure Space icon" style={{"display": "inline"}}/>) icon from the left navigation pane.
