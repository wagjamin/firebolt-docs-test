...
**Vacuuming**
  ...
  To ensure optimal query performance, you should periodically **vacuum** the aggregating index. [VACUUM](/sql_reference/commands/data-management/vacuum.md ) helps to:
