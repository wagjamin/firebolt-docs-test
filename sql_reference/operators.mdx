...
Use can use the `::` operator instead of the [CAST](/sql_reference/functions-reference/conditional-and-miscellaneous/cast) function to convert one [data type](/data-types) to another.
...
| `<type>`  | The target [data type](/data-types) (case-insensitive).|
