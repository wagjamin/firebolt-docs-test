...
| `<new_location_name>` | The new identifier for the location. Must be a valid identifier, see [Object identifiers](/Reference/object-identifiers). |
