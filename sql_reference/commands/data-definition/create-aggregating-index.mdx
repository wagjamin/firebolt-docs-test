---
description: Learn how to create and optimize aggregating indexes in Firebolt for
  faster query performance.
mode: wide
sidebarTitle: CREATE AGGREGATING INDEX
...
| `<aggregations>`    | [Aggregation functions](/sql_reference/functions-reference/aggregation) including `SUM`, `COUNT`, `AVG`, applied to table column expressions.  |
...
* [Create a simple aggregating index](/commands/data-definition#create-a-simple-aggregating-index)
* [Create a complex aggregating index](/commands/data-definition#create-a-complex-aggregating-index)
* [Compute AVG with multiple filters](/commands/data-definition#compute-avg-with-multiple-filters)
* [Filter by a calculated column](/commands/data-definition#filter-by-a-calculated-column)
...
You can use [EXPLAIN](/sql_reference/commands/queries/explain) to check if Firebolt is applying an aggregating index as shown in the following code example:
