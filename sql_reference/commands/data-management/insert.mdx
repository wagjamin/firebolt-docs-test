...
| `<expression>`<br/>--OR--<br/> `VALUES ([<value1>[, <value2>][, ...])]` | You can specify either a [`SELECT` query](/commands/queries/select) that determines values to or an explicit list of `VALUES` to insert.|
