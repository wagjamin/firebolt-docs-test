---
description: Reference and syntax for the COPY TO command that exports or unloads
  data from Firebolt to Amazon S3.
mode: wide
sidebarTitle: COPY TO
title: COPY TO
---
...
| `<location_name>`                    | The name of a location object that contains the Amazon S3 URL and credentials. This is the recommended approach for specifying the destination. See [CREATE LOCATION](/sql_reference/commands/data-definition/create-location) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `<URL>`                     | The path to an Amazon S3 URL where the query result file or files are saved. For example, `s3://my_bucket/my_folder`.                                                                                                                                                                                                                                                                                                                                                                                |
| `CREDENTIALS`                    | The Amazon S3 credentials for accessing the specified `<s3_url>`. For more information, see [CREDENTIALS](/commands/data-management#credentials).                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
For more information on how to create access keys, see [Creating Access Key and Secret ID](/Guides/loading-data/creating-access-keys-aws).
...
For more information about location objects, see [CREATE LOCATION](/sql_reference/commands/data-definition/create-location).
...
* [COPY TO with location object](/commands/data-management#copy-to-with-location-object)
* [COPY TO with defaults and role ARN](/commands/data-management#copy-to-with-defaults-and-role-arn)
* [COPY TO with single file and AWS access keys](/commands/data-management#copy-to-with-single-file-and-aws-access-keys)
* [COPY TO with custom file name prefix and ARN with external ID](/commands/data-management#copy-to-with-custom-file-name-prefix-and-arn-with-external-id)
* [COPY TO with custom file name and overwrite set to TRUE](/commands/data-management#copy-to-with-custom-file-name-and-overwrite-set-to-true)
