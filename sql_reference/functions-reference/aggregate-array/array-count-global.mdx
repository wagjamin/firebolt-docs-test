...
If you want to count elements based on specific criteria, you can use the [ARRAY_COUNT](/functions-reference/array/array-count) function with a `SUM` aggregation as demonstrated below.
