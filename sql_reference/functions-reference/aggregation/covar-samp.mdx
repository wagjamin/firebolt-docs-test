...
Use this when analyzing a sample rather than an entire population. For covariance of population see [COVAR_POP](/functions-reference/aggregation/covar-pop).
...
For information on correlation see [CORR](/functions-reference/aggregation/corr)
