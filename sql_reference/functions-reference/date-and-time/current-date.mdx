...
mode: wide
sidebarTitle: CURRENT_DATE
title: CURRENT_DATE
---


Returns the current local date in the time zone specified in the [session's `time_zone` setting](/Reference/system-settings#setting-the-time-zone).
