...
1. These functions extract part of the document, but preserve the original data in the result:
    * [JSON_EXTRACT](/functions-reference/JSON/json-extract)
    * [JSON_EXTRACT_ARRAY](/functions-reference/JSON/json-extract-array)
    * [JSON_POINTER_EXTRACT_VALUES](/functions-reference/JSON/json-pointer-extract-values)
2. These functions convert a JSON value to a SQL value:
    * [JSON_VALUE](/functions-reference/JSON/json-value)
    * [JSON_VALUE_ARRAY](/functions-reference/JSON/json-value-array)
    * [JSON_POINTER_EXTRACT_KEYS](/functions-reference/JSON/json-pointer-extract-keys)
3. This function extracts a JSON value and converts it to a SQL value, combining the functionalities of the previous two types of functions:
    * [JSON_POINTER_EXTRACT_TEXT](/functions-reference/JSON/json-pointer-extract-text)
