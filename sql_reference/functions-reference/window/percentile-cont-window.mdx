...
groups: []
mode: wide
sidebarTitle: PERCENTILE_CONT OVER
...
PERCENTILE\_CONT is available as an Window function. See also [PERCENTILE\_DISC](/functions-reference/window/percentile-disc-window), which returns a percentile over a partition equal to a specific column value. For more information on usage, please refer to [Window Functions](/functions-reference/window).
