...
See also [FIRST\_VALUE](/functions-reference/window/first-value), which returns the first value evaluated in the specified window frame. For more information on usage, please refer to [Window Functions](/functions-reference/window).
