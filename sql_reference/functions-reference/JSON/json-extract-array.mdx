...
mode: wide
sidebarTitle: JSON_EXTRACT_ARRAY
...
| `<path_syntax>`          | The expected syntax of the `<json_path_expression>` currently only supports 'JSONPointer'. For more information, see [JSON pointer expression syntax](/functions-reference/JSON#json-pointer-expression-syntax). | `TEXT`                | 
