...
This function pairs with the [JSON_EXTRACT](/functions-reference/JSON/json-extract) function, which doesn't convert the JSON values to SQL values.
...
see [JSON common example](/functions-reference/JSON#json-common-example). The **returned result** is based on this example.
