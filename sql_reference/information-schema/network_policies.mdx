---
description: Use this reference to learn about the metadata available about network
  policies using the information schema.
mode: wide
...
| network_policy_owner | TEXT        | The name of the identity to whom this network policy belongs.                                                                                          |
