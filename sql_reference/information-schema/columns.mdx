...
description: Use this reference to learn about the metadata available for Firebolt
  columns using the information schema.
mode: wide
...
To view column information, the user must have `USAGE` privileges on both the [schema](/Overview/Security/Role-Based Access Control/database-permissions/schema-permissions#schema-level-privileges) and the [database](/Overview/Security/Role-Based Access Control/database-permissions#database-level-privileges), as well as any necessary [table-level privileges](/Overview/Security/Role-Based Access Control/database-permissions/table-permissions#table-level-privileges) or ownership of the table.
