---
description: Use this reference to learn about the metadata available for historical
  queries in Firebolt.
mode: wide
sidebarTitle: Engine query history
...
| scanned_storage_bytes      | BIGINT      | The total number of compressed bytes scanned from Firebolt-managed storage. Does not apply to [EXTERNAL tables](/Overview/indexes/using-indexes#external-tables).|
