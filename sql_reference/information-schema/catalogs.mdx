...
description: Use this reference to learn about the metadata available for Firebolt
  databases using the information schema.
mode: wide
...
In order to view catalog information, you must have [catalog](/Overview/Security/Role-Based Access Control/database-permissions#database-level-privileges) privileges or have ownership of the catalog object.
