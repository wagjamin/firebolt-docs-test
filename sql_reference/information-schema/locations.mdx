...
To view location information, you must have `LIST LOCATION` or `LIST ANY LOCATION` privileges. For more information about location permissions, see [CREATE LOCATION](/sql_reference/commands/data-definition/create-location).
