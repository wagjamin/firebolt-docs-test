...
description: Use this reference to learn about the metadata available for Firebolt
  users using the information schema.
mode: wide
sidebarTitle: Users
title: Users
---
...
To view information about users, you must have [user privilege](/Overview/Security/Role-Based Access Control/user-permissions#user-permissions) or ownership of the user object.
