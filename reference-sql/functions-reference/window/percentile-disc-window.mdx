...
groups: []
sidebarTitle: PERCENTILE_DISC OVER
...
PERCENTILE\_DISC is available as a Window function. See also [PERCENTILE\_CONT](/reference-sql/functions-reference/window/percentile-cont-window), which calculates an interpolated result over a partition, rather than matching any of the specific column values. For more information on usage, please refer to [Window Functions](/reference-sql/functions-reference/window).
