...
See also [FIRST\_VALUE](/reference-sql/functions-reference/window/first-value), which returns the first value evaluated in the specified window frame. For more information on usage, please refer to [Window Functions](/reference-sql/functions-reference/window).
