...
See also [PERCENT_RANK](/reference-sql/functions-reference/window/percent-rank), which returns the relative rank of the current row within an ordered data set. For more information on usage, please refer to [Window Functions](/reference-sql/functions-reference/window).
