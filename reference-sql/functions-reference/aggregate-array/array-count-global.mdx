...
groups: []
sidebarTitle: ARRAY_COUNT_GLOBAL
...
If you want to count elements based on specific criteria, you can use the [ARRAY_COUNT](/reference-sql/functions-reference/array/array-count) function with a `SUM` aggregation as demonstrated below.
