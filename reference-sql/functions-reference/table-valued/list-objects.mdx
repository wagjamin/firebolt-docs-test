...
|:----------|:------------|:---------------------|
| `LOCATION` | The name of a location object that contains the S3 URL and credentials. This is the recommended approach. See [CREATE LOCATION](/reference-sql/commands/data-definition/create-location) for details. | `IDENTIFIER` |
