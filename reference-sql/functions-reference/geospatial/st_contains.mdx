...
Before performing the containment check, `geo1` and `geo2` are aligned through a snapping process, ensuring precise calculation. For more details on snapping, refer to the [snapping documentation](/reference-sql/geography-data-type#snapping).
...
## Comparison with [ST_COVERS](/reference-sql/functions-reference/geospatial/st_covers)
