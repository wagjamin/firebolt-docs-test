...
## <img src="/assets/images/icon-data_management.png" alt="Icon for data management." width="40" style={{"display": "inline"}}/> Data management
...
## <img src="/assets/images/icon-processing.png" alt="Icon for query processing." width="40" style={{"display": "inline"}}/> Query processing
...
For more information, see the [Firebolt API](/guides/query-data/using-the-api), and the Firebolt [functions glossary](/reference-sql/functions-reference/functions-glossary).

## <img src="/assets/images/icon-security.png" alt="Icon for security." width="40" style={{"display": "inline"}}/> Security
...
## <img src="/assets/images/icon-observability.png" alt="Icon for observability." width="40" style={{"display": "inline"}}/> Observability
...
## <img src="/assets/images/icon-collaboration.png" alt="Icon for collaboration." width="40" style={{"display": "inline"}}/> Collaborative workspace
