...
### <img src="/assets/images/icon-efficiency.png" alt="Icon for efficiency." width="40" style={{"display": "inline"}}/> High efficiency
...
### <img src="/assets/images/icon-concurrency.png" alt="Icon for concurrency at scale." width="40" style={{"display": "inline"}}/> Concurrency at scale
...
### <img src="/assets/images/icon-elasticity.png" alt="Icon for elasticity or vertical, horizontal or concurrent scaling." width="40" style={{"display": "inline"}}/> Elasticity
...
### <img src="/assets/images/icon-isolation.png" alt="Icon for workload isolation." width="40" style={{"display": "inline"}}/> Workload isolation for smooth operations
...
Read about Firebolt's [platform capabilities](/intro/product-platform).

## More Firebolt resources

Learn how to load and query your data with our [Get Started](/guides/getting-started) and [Load data](/guides/loading-data) guides or use one of Firebolt’s [test data sets](https://www.firebolt.io/free-sample-datasets). 
...
<a
    ...
    class="cta-arrow pricing w-inline-block">Sign up</a> to access your $200 Firebolt credit for your first 30 days. No credit card needed.
