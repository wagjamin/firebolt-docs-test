...
import ReleaseNotesReleaseNotes419 from '/snippets/release_notes/release_notes_4_19.mdx';

<ReleaseNotesReleaseNotes419  />




import ReleaseNotesReleaseNotes418 from '/snippets/release_notes/release_notes_4_18.mdx';

<ReleaseNotesReleaseNotes418  />




import ReleaseNotesReleaseNotes417 from '/snippets/release_notes/release_notes_4_17.mdx';

<ReleaseNotesReleaseNotes417  />




import ReleaseNotesReleaseNotes416 from '/snippets/release_notes/release_notes_4_16.mdx';

<ReleaseNotesReleaseNotes416  />




import ReleaseNotesReleaseNotes415 from '/snippets/release_notes/release_notes_4_15.mdx';

<ReleaseNotesReleaseNotes415  />




import ReleaseNotesReleaseNotes414 from '/snippets/release_notes/release_notes_4_14.mdx';

<ReleaseNotesReleaseNotes414  />




import ReleaseNotesReleaseNotes413 from '/snippets/release_notes/release_notes_4_13.mdx';

<ReleaseNotesReleaseNotes413  />




import ReleaseNotesReleaseNotes412 from '/snippets/release_notes/release_notes_4_12.mdx';

<ReleaseNotesReleaseNotes412  />




import ReleaseNotesReleaseNotes411 from '/snippets/release_notes/release_notes_4_11.mdx';

<ReleaseNotesReleaseNotes411  />




import ReleaseNotesReleaseNotes410 from '/snippets/release_notes/release_notes_4_10.mdx';

<ReleaseNotesReleaseNotes410  />




import ReleaseNotesReleaseNotes49 from '/snippets/release_notes/release_notes_4_9.mdx';

<ReleaseNotesReleaseNotes49  />




import ReleaseNotesReleaseNotes48 from '/snippets/release_notes/release_notes_4_8.mdx';

<ReleaseNotesReleaseNotes48  />




import ReleaseNotesReleaseNotes47 from '/snippets/release_notes/release_notes_4_7.mdx';

<ReleaseNotesReleaseNotes47  />




import ReleaseNotesReleaseNotes46 from '/snippets/release_notes/release_notes_4_6.mdx';

<ReleaseNotesReleaseNotes46  />




import ReleaseNotesReleaseNotes45 from '/snippets/release_notes/release_notes_4_5.mdx';

<ReleaseNotesReleaseNotes45  />




import ReleaseNotesReleaseNotes440 from '/snippets/release_notes/release_notes_4_4_0.mdx';

<ReleaseNotesReleaseNotes440  />
...
Removed support for `json_extract_raw`, `json_extract_array_raw`, `json_extract_values`, and `json_extract_keys`. Updated `json_extract` function: the third argument is now `path_syntax`, which is a JSON pointer expression. See [JSON_EXTRACT](/reference-sql/functions-reference/json/json-extract) for examples and usage. 

 **Cluster ordinal update**

Replaced `engine_cluster` with [cluster_ordinal](/reference-sql/information-schema/engine-metrics-history) in `information_schema.engine_metrics_history`. The new column is an integer representing the cluster number.

 **Configurable cancellation behavior on connection drop**

Introduced the `cancel_query_on_connection_drop` setting, allowing clients to control query cancellation on HTTP connection drop. Options include `NONE`, `ALL`, and `TYPE_DEPENDENT`. Refer to [system settings](/reference/system-settings#query-cancellation-mode-on-connection-drop) for examples and usage. 
...
The `match` function has been removed and replaced with [regexp_like](/reference-sql/functions-reference/string/regexp-like). 
...
The [array_first](/reference-sql/functions-reference/lambda/array-first) function has been added. It returns the first element in the given array for which the given function returns `true`.

**New name for `any_match`**

A new name for `any_match` has been added: [array_any_match](/reference-sql/functions-reference/lambda/array-any-match). `any_match` will be kept as an alias. 
...
Support has been added to allow the [ARRAY_ANY_MATCH](/reference-sql/functions-reference/lambda/array-any-match) lambda function to work with nullable arrays.
...
[LATERAL](/reference/reserved-words) is now a reserved keyword. It must now be used within double-quotes when using it as an object identifier.
...
Changed the behavior of [split_part](/reference-sql/functions-reference/string/split-part) when an empty string is used as delimiter.
...
[New comparison operators](/reference-sql/operators) `IS DISTINCT FROM` and `IS NOT DISTINCT FROM` have been added.
...
A new alias [ARRAY_TO_STRING](/reference-sql/functions-reference/array/array-to-string) has been added to function `ARRAY_JOIN`.
