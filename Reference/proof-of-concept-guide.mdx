...
The data used in the proof of concept should be made available in an S3 region ([any region](/available-regions) is fine). To ensure the proof of concept accurately reflects your production workload, it's recommended to have all or a significant portion of the data available.
