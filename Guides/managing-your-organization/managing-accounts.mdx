...
To view all accounts, click **Configure** to open the configure space, then choose **Accounts** from the menu, or query the [information_schema.accounts](/sql_reference/information-schema/accounts) view. 
...
### SQL
 To create an account using SQL, use the [CREATE ACCOUNT](/sql_reference/commands/data-definition/create-account) statement. For example:
...
### SQL 
To edit an existing account using SQL, use the [ALTER ACCOUNT](/sql_reference/commands/data-definition/alter-account) statement. For example:
...
### SQL 
To delete an existing account using SQL, use the [DROP ACCOUNT](/sql_reference/commands/data-definition/drop-account) statement. For example:
