...
1. [Create a service account](/managing-your-organization#create-a-service-account).
2. [Generate a secret](/managing-your-organization#generate-a-secret).
3. [Get a service account ID](/managing-your-organization#get-a-service-account-id).
...
1. [Test your new service account](/managing-your-organization#test-your-new-service-account).
2. [Edit your service account](/managing-your-organization#edit-your-service-account).
3. [Delete your service account](/managing-your-organization#delete-your-service-account).
