---
description: Learn about using the Firebolt manager (web application) to work with
  Firebolt engines, which provide the compute power for Firebolt queries.
groups: []
mode: wide
sidebarTitle: Work with engines using the Firebolt Manager
...
For more information about settings and their meanings, see [Understanding engine properties](/Overview/engine-fundamentals).
