...
* Most [data definition](/sql_reference/commands/data-definition) commands. The following commands are not supported:
  * [ALTER TABLE DROP PARTITION](/sql_reference/commands/data-definition/alter-table)
  * [CREATE AGGREGATING INDEX](/sql_reference/commands/data-definition/create-aggregating-index)
  * [CREATE EXTERNAL TABLE](/sql_reference/commands/data-definition/create-external-table)
  * [CREATE TABLE AS SELECT](/sql_reference/commands/data-definition/create-fact-dimension-table-as-select)
* Most [metadata](/sql_reference/commands/metadata) commands. The following commands are not supported:
  * [SHOW CACHE](/sql_reference/commands/metadata/show-cache)
* Non-data-accessing [SELECT](/sql_reference/commands/queries/select) queries like `SELECT CURRENT_TIMESTAMP()`
* [SELECT](/sql_reference/commands/queries/select) queries on some [information_schema](/sql_reference/information-schema) views:
    * [information_schema.accounts](/sql_reference/information-schema/accounts)
    * [information_schema.applicable_roles](/sql_reference/information-schema/applicable-roles)
    * [information_schema.transitive_applicable_roles](/sql_reference/information-schema/transitive-applicable-roles)
    * [information_schema.columns](/sql_reference/information-schema/columns)
    * [information_schema.catalogs](/sql_reference/information-schema/catalogs)
    * [information_schema.enabled_roles](/sql_reference/information-schema/enabled-roles)
    * [information_schema.engines](/sql_reference/information-schema/engines)
    * [information_schema.indexes](/sql_reference/information-schema/indexes)
    * [information_schema.logins](/sql_reference/information-schema/logins)
    * [information_schema.network_policies](/sql_reference/information-schema/network_policies)
    * [information_schema.service_accounts](/sql_reference/information-schema/service-accounts)
    * [information_schema.tables](/sql_reference/information-schema/tables)
    * [information_schema.users](/sql_reference/information-schema/users)
    * [information_schema.views](/sql_reference/information-schema/views)
...
Guidance on creating service accounts can be found in the [service account](/managing-your-organization/service-accounts) section.
