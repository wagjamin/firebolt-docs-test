...
|:---------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Role     | N/A                                                                                                                                                                    |
| User     | [information_schema.users](/sql_reference/information-schema/users)                                                                                       |
| Database | [information_schema.catalogs](/sql_reference/information-schema/catalogs)                                                                                 |
| Engine   | [information_schema.engines](/sql_reference/information-schema/engines)                                                                                   |
| Schema   | [information_schema.schemata](/sql_reference/information-schema/schemata)                                                                                 |
| Table    | [information_schema.tables](/sql_reference/information-schema/tables)                                                                                     |
| View     | [information_schema.views](/sql_reference/information-schema/views) or [information_schema.tables](/sql_reference/information-schema/tables) |

<Note>
Index ownership, shown in [information_schema.indexes](/sql_reference/information-schema/indexes), will always show the table owner as an index's owner.
</Note>
...
| Object          | View                                                                                                   |
|:----------------|:-------------------------------------------------------------------------------------------------------|
| Organization    | [information_schema.organization](/sql_reference/information-schema/organization)         |
| Account         | [information_schema.accounts](/sql_reference/information-schema/accounts)                 |
| Login           | [information_schema.logins](/sql_reference/information-schema/logins)                     |
| Service Account | [information_schema.service_accounts](/sql_reference/information-schema/service-accounts) |
| Network Policy  | [information_schema.network_policies](/sql_reference/information-schema/network_policies) |
...
<Note>
A table owner can drop the table even if there are views referencing it that are not owned by the table's owner, using the `CASCADE` parameter to [DROP TABLE](/sql_reference/commands/data-definition/drop-table).
</Note>
