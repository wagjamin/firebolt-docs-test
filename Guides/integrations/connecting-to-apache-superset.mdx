...
Firebolt is also supported in [Preset](/integrations/connecting-to-preset), a fully managed cloud Superset solution.
...
On the next screen, press the `+ Database` button and select Firebolt from the dropdown. If you don't see Firebolt in the list, please refer to the [Setup Superset](/integrations#setup-superset) section for instructions on how to install the Firebolt driver and verify that the driver is present.
...
Learn how to generate an ID and secret [here](/managing-your-organization/service-accounts).

Account name must be provided, you can learn about accounts in [Manage accounts](/managing-your-organization/managing-accounts) section.
...
> **Note:**  This section assumes you have followed Firebolt [tutorial](/getting-started) and loaded a sample data set into your database.
