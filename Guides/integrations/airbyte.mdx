...
If you already have an airbyte deployment skip to the [configuration section](/integrations#step-2-configure-firebolt-connection-via-ui).
...
4. **Firebolt Service Account**: Create a [service account](/managing-your-organization/service-accounts) in Firebolt and note its id and secret.
...
3. Enter your Firebolt connection details:
   ...
   - Account: Your firebolt [account](/managing-your-organization/managing-accounts).
