...
* To have a Firebolt account and service account [credentials](/managing-your-organization/service-accounts).
* [Load data](/loading-data/loading-data) you want to visualise.
...
To build a chart you can follow our guide in the [Superset section](/integrations/connecting-to-apache-superset#build-your-first-chart), as the Preset works identically.
