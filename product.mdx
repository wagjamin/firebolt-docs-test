...
<Frame>
  <img src="https://docs.firebolt.io/assets/images/product-scaling-engines.png" />
</Frame>
...
<Frame>
  <img src="https://docs.firebolt.io/assets/images/firebolt-framework.png" />
</Frame>

### <img src="https://docs.firebolt.io/assets/images/icon-isolation.png" /> Workload isolation for smooth operations
...
Read about Firebolt’s [platform capabilities](/product/product-platform).

## More Firebolt resources

Learn how to load and query your data with our [Get Started](/Guides/getting-started/) and [Load data](/Guides/loading-data/loading-data) guides or use one of Firebolt’s [test data sets](https://www.firebolt.io/free-sample-datasets).
