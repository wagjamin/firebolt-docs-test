...
**Topics**
* [Scope of history-based optimization](/queries#scope-of-history-based-optimization) &ndash; Learn which processes utilize history-based optimization.
* [How it works](/queries#how-it-works) &ndash; Learn how telemetry data and query history help optimize future query plans and performance.
  * [How recording query history works](/queries#how-recording-query-history-works) &ndash; Learn what is recorded in query history and how information is protected.
  * [How planning queries based on history work](/queries#how-planning-queries-based-on-history-work) &ndash; Learn how history-based snapshots are continually updated to improve query performance across all engines in the same database and account.
* [Observability](/queries#observability) &ndash; Learn how to check if history-based optimization is used in your query plan.
...
For more information about output from `EXPLAIN (statistics)`, including various possible values that the source field can take, see [Explain: Example with statistics](/sql_reference/commands/queries/explain#example-with-statistics).
