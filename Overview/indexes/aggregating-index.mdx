...
mode: wide
sidebarTitle: Aggregating index
...
Topics:
- [Aggregating index](/indexes#aggregating-index)
...
**Vacuuming**
  ...
  To ensure optimal query performance, you should periodically **vacuum** the aggregating index. [VACUUM](/sql_reference/commands/data-management/vacuum) helps to:
