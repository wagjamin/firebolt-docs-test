...
Topics:
* [Key features](/indexes#key-features)
* [Syntax](/indexes#syntax)
* [Parameters](/indexes#parameters)
* [Example](/indexes#example)
* [Considerations](/indexes#considerations)
* [Advanced option: index granularity](/indexes#advanced-option-index-granularity)
...
| `index_granularity` | The maximum number of rows in each granule. See [Index granularity](/indexes#advanced-option-index-granularity). |
...
* **Managing fragmentation**:  
  ...
  - **[VACUUM](/sql_reference/commands/data-management/vacuum) command**:  
...
The `index_granularity` [storage parameter](/sql_reference/commands/data-definition/create-fact-dimension-table#storage-parameters),
